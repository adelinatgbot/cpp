...
//    while (p != NULL)
//    {
//        if (p->info > 0 && p->next != NULL && p->next->info % 2 == 0)
//        {
//            del(beg, p->info);
//            p = beg;
//        }
...
//6 Вставить элемент со значением количества положительных элементов списка, до каждого трехзначного числа.
